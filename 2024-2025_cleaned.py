...
import pandas as pd
df = pd.read_csv(r"D:\BD_apparel_export_project\Fiscal year wise source file\2024-2025.csv",encoding="latin1", dtype=str)
df = df.drop([0, 1, 2, 3])
...
final_df.to_csv('2024-2025_cleaned.csv', index=False)
