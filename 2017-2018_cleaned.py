...
import pandas as pd
df = pd.read_csv(r"D:\BD_apparel_export_project\Fiscal year wise source file\2017-2018.csv",encoding="latin1", dtype=str)
...
final_df.to_csv('2017-2018_cleaned.csv', index=False)
