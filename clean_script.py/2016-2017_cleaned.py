...
import pandas as pd
df = pd.read_csv(r"D:\BD_apparel_export_project\Fiscal year wise source file\2016-2017 Export data.csv",encoding="latin1", dtype=str)
df = df.drop([0, 1, 2, 3])
...
final_df.to_csv('2016-2017_cleaned.csv', index=False)
