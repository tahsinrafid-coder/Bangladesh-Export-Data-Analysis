...
import pandas as pd
df = pd.read_csv(r"D:\BD_apparel_export_project\Fiscal year wise source file\2018-2019 .csv",encoding="latin1", dtype=str)
...
final_df.to_csv('2018-2019_cleaned.csv', index=False)
