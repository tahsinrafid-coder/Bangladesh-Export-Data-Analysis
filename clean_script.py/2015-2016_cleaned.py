#import pandas and read the csv file, reset the index
import pandas as pd
df = pd.read_csv(r"D:\BD_apparel_export_project\Fiscal year wise source file\2015-2016.csv",encoding="latin1", dtype=str)
df = df.reset_index(drop=True)

# Drop any unnamed columns automatically
...
df = df[
    df["description"].str.match(r"^\d{8}: ", na=False)
].copy()
...
final_df.to_csv('2015-2016_cleaned.csv', index=False)   
